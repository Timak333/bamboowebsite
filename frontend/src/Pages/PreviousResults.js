                    ...
                    {pastCalculations.map((calc, index) => (
                        <Card key={index} className="calculationCard">
                            <CardContent>
                                ...
                                <p><strong>Duration:</strong>{calc.duration ? `${calc.duration} days` : "N/A"} </p>
                                <p><strong>Materials:</strong>{calc.materials ? calc.materials.map(m => m.name).join(', ') : "N/A"} </p>
                                <p><strong>Energy Sources:</strong>{calc.energy_source ? calc.energy_source.map.join(', ') : "N/A"} </p>
                                <p><strong>Quantity:</strong> {calc.quanity || "N/A"}</p>
                                <p><strong>Transport Modes:</strong>{calc.transport_modes ? calc.transport_modes.join(', ') : "N/A"} </p>
                            </CardContent>
                        </Card>
                    ))}
                </List>
